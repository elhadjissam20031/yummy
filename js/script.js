...
const inputsContact = document.querySelectorAll("#formContact input");
function enabledBtn() {
  if (
    checkName() === true ||
    checkEmail() === true ||
...
inputsContact.forEach((element) =>
  element.addEventListener("keydown", enabledBtn)
);
